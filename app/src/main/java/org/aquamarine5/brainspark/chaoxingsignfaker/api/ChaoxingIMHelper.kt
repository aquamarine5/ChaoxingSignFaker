            ...
            it.extList?.forEach { ext ->
                if (ext.key == "attachment") {
                    ...
                    if (attachObject.getInteger("attachmentType") == 15) {
                        val signInfo = attachObject.getJSONObject("att_chat_course") ?: return@forEachImMessages
                        val courseInfo = signInfo.getJSONObject("courseInfo") ?: return@forEachImMessages
